...
add_requires("nazaraengine 81c5322331d3e6e6f297ea5eb5515dc77f01d5b0", { alias = "nazara", debug = is_mode("debug") })
add_requires("nazaraimgui c0a51732d0a54d4a1ae9debe64baf0c8de876f89", { alias = "nzimgui", debug = is_mode("debug") })
add_requires("nazaralocalization", { alias = "nzloca", debug = is_mode("debug") })
add_requireconfs("**.nazaraengine", { version = "81c5322331d3e6e6f297ea5eb5515dc77f01d5b0", override = true })
